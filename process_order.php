...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_POST['order_info'])) {
		...
		if ($name != "" && $addr != "" && $email != "" && $phone != "" && $food != "" && $price != "") {
			...
			$insert = $db->query("INSERT INTO basket(customer_name, contact_number, address, email, total, status, date_made, id_user) VALUES('" . $name . "', '" . $phone . "', '" . $addr . "', '" . $email . "', '" . $price . "', 'pending', NOW(),'" . $iduser . "')");
