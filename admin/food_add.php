            ...
            if (in_array($ext[1], $allowed_ext)) {
                ...
                if ($check->num_rows) {
                    ...
                    if ($insert) {
                        ...
                        $db->query("UPDATE food SET `img_category`='$nameImg' WHERE `id`='$ins_id'");
                ...
                <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#" style="color: #fff;">ADD NEW PRODUCT</a>
                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">Product Add Form</h4>
                                    </div>
                                    <div class="content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off" name="name" class="form-control" placeholder="Enter Product Name" required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off" name="price" id="price" class="form-control" placeholder="Enter Food Price" required />
                                                    </div>
                                                </div>
                                            </div>
