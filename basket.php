...
$email = $row['email'];
$nama = $row['nama'];
// var_dump($iduser, $alamat, $notlp, $email, $nama);
...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
	...
	$cartTotal = '<p class="p_total"><span>Basket Total</span> : Rp.' . $cartTotal . '</p>';
}
?>
		...
		<form method="post" action="" onSubmit="validate_input(); return false">
			...
			<div class="form_group">
				...
				<div class="form_group">
					...
					<label>Name</label>
					<input type="text" id="name" name="name" value="<?php echo $nama; ?>" required>
				...
				<div class="form_group">
					...
					<label>Address</label>
					<input type="text" id="addr" name="addr" value="<?php echo $alamat; ?>" required>
				...
				<div class="form_group">
					...
					<input type="text" id="phone" name="phone" value="<?php echo $notlp; ?>" required>
