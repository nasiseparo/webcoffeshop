...
<body>
	...
	<div class="content remove_pad" onclick="remove_class()">
		...
		<div class="inner_content on_parallax">
			...
			<h2><span class="fresh">Menu Description</span></h2>
					...
					<div class="detail_desc">
						...
						<form class="" method="post" action="detail.php">
							...
							<div class="form_group">
								...
								<p class="label_center"><label class="subtract" onclick="subtract_price();">-</label><input readonly type="text" id="amount" name="amount" value="1"><label class="add" onclick="sum_price();">+</label>
									<p>
